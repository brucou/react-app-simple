...
import {
  Counter, GalleryApp, Hello, InputWithExplicitRef, InputWithImplicitRef, TextMessage,
} from './sample-components';
import {
  BUTTON_CLICKED, COMMAND_SEARCH, ENTER_KEY_PRESSED, KEY_ENTER, KEY_PRESSED, NO_ACTIONS, NO_INTENT, NO_STATE_UPDATE
} from "../properties";
